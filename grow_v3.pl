#!/usr/bin/perl
# grow_v3.pl - Primordial Soup Evolution Engine
#
# Three-phase evolution inspired by abiogenesis:
#   Phase 1: Primordial soup — generate behaviorally diverse program fragments
#   Phase 2: Curriculum — staged fitness functions build complexity incrementally
#   Phase 3: Directed evolution — target-specific fitness with horizontal gene transfer
#
# Usage: perl grow_v3.pl [target] [generations] [seed]
# Example: perl grow_v3.pl fib 2000
#          perl grow_v3.pl primes 3000 42
